...
with DAG(dag_id="risk_calculation-serverless", start_date=pendulum.datetime(2022, 2, 12), catchup = False, concurrency=10) as dag:
    ...
    def read_portfolios():
        ...
        return list(json.loads(str(map(lambda p: "{}".format(json.dumps(p))), data)))
